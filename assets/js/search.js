...
(function () {
  ...
  const SEARCH_INDEX = [
    ...
    /* EXPANSION LIBRARY */
    { id:'expansion', title:'Expansion Library — Wikipedia & Gutenberg Offline', section:'expansion', sectionLabel:'Expansion Library', file:'expansion.html', anchor:'', content:'expansion library kiwix zim wikipedia offline project gutenberg download all human knowledge medical wikipedia wikimed simple english wiktionary ifixit wikivoyage wikibooks wikisource encyclopedia pen drive offline reader', tags:['kiwix','zim','wikipedia','gutenberg','offline','expansion','download'] },
